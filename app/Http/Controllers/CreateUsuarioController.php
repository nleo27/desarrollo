    ...
    public function update(Request $request, $id)
        {
            ...
            // Si el usuario cambió de área
            if ($usuario->area_id != $request->input('area_id')) {
                // Obtener el área anterior del usuario
                $area_anterior = $usuario->area;

                // Verificar si el usuario tiene carpetas asignadas
                if ($usuario->carpetas) {
                    // Desvincular las carpetas del usuario en el área anterior
                    foreach ($usuario->carpetas as $carpeta) {
                        $carpeta->area_id = null;
                        $carpeta->save();
                    }
                }
